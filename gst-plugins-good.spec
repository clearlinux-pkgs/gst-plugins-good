...
Source0  : https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.24.1.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.24.1.tar.xz.asc
...
%prep
%setup -q -n gst-plugins-good-1.24.1
cd %{_builddir}/gst-plugins-good-1.24.1
pushd ..
cp -a gst-plugins-good-1.24.1 buildavx2
popd
pushd ..
cp -a gst-plugins-good-1.24.1 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711236639
