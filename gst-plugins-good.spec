...
Source0  : https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.26.0.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.26.0.tar.xz.asc
...
%setup -q -n gst-plugins-good-1.26.0
cd %{_builddir}/gst-plugins-good-1.26.0
pushd ..
cp -a gst-plugins-good-1.26.0 buildavx2
popd
pushd ..
cp -a gst-plugins-good-1.26.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742832373
