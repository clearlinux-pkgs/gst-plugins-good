...
Source0  : https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.10.2.tar.xz
...
%prep
%setup -q -n gst-plugins-good-1.10.2

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483143462
